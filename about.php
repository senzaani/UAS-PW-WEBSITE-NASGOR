...
<body>
    ...
    <div class="container mx-auto px-6 py-10">
        <h1 class="text-4xl font-bold text-center text-gray-800 mb-8">Tentang Kami</h1>
        <div class="bg-white p-8 rounded-lg shadow-lg">
            <p class="text-lg text-gray-700 mb-4">
                <span class="font-semibold text-xl">Self-Service</span> merupakan metode pemesanan menu dari <span
                    class="font-semibold text-yellow-600">Nasi Goreng Pak Gento</span> yang memungkinkan pelanggan
                memilih menu makanan dan minuman secara mandiri melalui perangkat digital seperti layar sentuh atau
                aplikasi ponsel.
            </p>
            <p class="text-lg text-gray-700 mb-4">
                Pelanggan bisa melihat menu nasi goreng yang tersedia dan memilih variasi yang diinginkan. Setelah
                memilih, pelanggan melakukan pembayaran digital, baik melalui tunai maupun Qris. Pesanan kemudian
                langsung diterima oleh dapur untuk diproses. Metode ini meningkatkan efisiensi, mengurangi antrean, dan
                memberi pengalaman pemesanan yang praktis dan cepat bagi pelanggan.
            </p>
            <p class="text-lg text-gray-700 mb-4">
                Dengan menggunakan teknologi terbaru, <span class="font-semibold text-yellow-600">Nasi Goreng Pak
                    Gento</span> berkomitmen untuk memberikan kenyamanan dan kepuasan kepada setiap pelanggan kami. Kami
                percaya bahwa dengan kemudahan pemesanan melalui sistem digital, pelanggan dapat menikmati waktu makan
                yang lebih efisien tanpa perlu menunggu lama.
            </p>
            <p class="text-lg text-gray-700 mb-4">
                Kami juga terus berinovasi untuk menyediakan variasi menu yang lezat dan menggugah selera. Selain nasi
                goreng, kami menawarkan pilihan minuman yang menyegarkan dan berbagai hidangan lainnya yang sesuai
                dengan selera pelanggan. Semua hidangan disiapkan dengan bahan-bahan segar dan kualitas terbaik.
            </p>
            <p class="text-lg text-gray-700 mb-4">
                Kami berharap dengan hadirnya layanan Self-Service ini, <span class="font-semibold text-yellow-600">Nasi
                    Goreng Pak Gento</span> dapat memberikan pengalaman yang lebih baik bagi pelanggan kami, sekaligus
                meningkatkan kualitas layanan kami dalam memberikan kepuasan kepada setiap orang yang datang.
            </p>
        </div>
    </div>
